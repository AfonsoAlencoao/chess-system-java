...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String pieceType) {
		...
		if (!pieceType.equals("B") && !pieceType.equals("N") && !pieceType.equals("R") && !pieceType.equals("Q")) {
			throw new InvalidParameterException("Invalid piece type for promotion");
		}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("There is no " + color + " king on the board"); // Not supposed to happen
	}
